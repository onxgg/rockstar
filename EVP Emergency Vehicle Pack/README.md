...
- Developer Details: Holds optimization and asset details for each vehicle in the EVP Pack.
- Livery Templates: Holds blank model.yft files and PNG templates for easy custom livery creation.
